...
export const sampleInvoices: Invoice[] = [
  ...
  },
  {
    ...
    clientEmail: 'mellisa@email.co.uk',
    status: 'pending',
    senderAddress: { street: '19 Union Terrace', city: 'London', postCode: 'E1 3EZ', country: 'United Kingdom' },
  ...
  },
  {
    ...
    status: 'pending',
    senderAddress: { street: '19 Union Terrace', city: 'London', postCode: 'E1 3EZ', country: 'United Kingdom' },
    clientAddress: { street: '3rd Floor, 86 Murray Street', city: 'Glasgow', postCode: 'G3 7HR', country: 'United Kingdom' },
    items: [
      { name: 'Logo Re-design', quantity: 1, price: 3102.04, total: 3102.04 },
      { name: 'Stationery', quantity: 7, price: 45.99, total: 321.93 },
      { name: 'Thank you cards', quantity: 14, price: 33.14, total: 463.96 },
      { name: 'Envelopes', quantity: 100, price: 0.80, total: 80.00 },
      { name: 'Gold Leaf Letters', quantity: 10, price: 22.75, total: 227.50 },
    ],
    total: 4195.43,
  },
  {
    ...
    items: [
      ...
      { name: 'Logo Design', quantity: 1, price: 3000.00, total: 3000.00 },
    ],
    total: 3102.04,
  },
];
